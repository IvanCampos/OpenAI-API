...
async function gpt4_API_Completions() {
...
function createReceipt(json) {
    ...
    return "<hr/><div><span>" + model + " </span><span style='font-family: Poppins; font-weight: bolder;'>RECEIPT</span></div><br/>" +
    "<div style='font-family: Poppins'>Prompt Tokens:  <span style='font-family: Orbitron'>" + promptTokens + "</span></div><br/>" +
    "<div style='font-family: Poppins'>Completion Tokens:  <span style='font-family: Orbitron'>" + completionTokens + "</span></div><br/>" +
    "$" + calculateCost(json.model, promptTokens, completionTokens);
}
...
function calculateCost(engineName, promptTokens, completionTokens, wordCount = false) {
    let totalCost = 0;
    //Prices per 1000 tokens
    const PROMPT_PRICE = 0.03;
    const COMPLETION_PRICE = 0.06;
    let promptCost = PROMPT_PRICE * (promptTokens/1000);
    let completionCost = COMPLETION_PRICE * (completionTokens/1000);
